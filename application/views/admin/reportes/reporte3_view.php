...
<div class="row">
    <div class="col-md-12">
        <ul class="nav nav-tabs" id="sub_menu_pasos">
            ...
            <li class="active"><a href="<?php echo base_url() ?>admin/reportes/presupuesto2.jsp" data-name="presupuesto_2">Reporte 3</a></li>
        </ul>
    </div>
</div>
<div class="row">
    <form action="<?php echo base_url(); ?>admin/reportes/genera_presupuesto2.jsp" class="form-horizontal" id="reporte2_form">
